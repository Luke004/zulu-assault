...
public class Level_5 extends AbstractLevel implements GameState {

    private static Sound level5_intro_sound;
    private static Music level5_music;
    ...
    public void init(GameContainer gameContainer, StateBasedGame stateBasedGame) throws SlickException {
        if (!calledOnce) {
            mission_title = "Cross the River";
            briefing_message = "The enemy has fortified the bank of the river and has complete air superiority over "
                    + "the area. We need to take the base on the other side. Our operatives have placed a transporter "
                    + "that may help in your attack. Cross the river and destroy the base.";
            debriefing_message = "Base Destroyed. Excellent Shooting.";
            calledOnce = true;
            return;
        }
        ...
        level_intro_sound = level5_intro_sound;
        level_music = level5_music;
    ...
    public void loadLevelMusic() {
        if (level5_intro_sound == null) {
            try {
                level5_intro_sound = new Sound("audio/music/level_5_intro.ogg");
                level5_music = new Music("audio/music/level_5.ogg");
